...
export const hero = {
  ...
  summary:
    "I work on APIs, data pipelines, observability, production debugging, and security tooling. The kind of work I enjoy most is the work that has to hold up after launch, not just look good in a demo.",
  mission:
    "Build systems that stay clear, reliable, and useful once real traffic and failure modes show up.",
  focus: [
    "Backend services, APIs, and ingestion pipelines in Go, Python, and Rust",
  ...
  utilityLinks: [
    ...
    { label: "Recent work", value: "Enterprise NIDS, Patchbot, Sysguard, and systems security projects", href: "/projects/" },
