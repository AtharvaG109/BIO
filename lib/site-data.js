...
export const siteConfig = {
  ...
  initials: "AG",
  title: "Software Engineer and Cybersecurity Engineer",
  location: "Davis, California",
  email: "atharvam10@icloud.com",
  phone: "+1 (240) 879-8063",
  linkedin: "https://www.linkedin.com/in/avg1048",
  description:
    "Portfolio of Atharva Vijayanand Gham, a software and security engineer focused on distributed services, observability, debugging, application security, and operational resilience.",
  availability:
    "Seeking software, systems, platform, or security engineering roles where technical ownership, performance, and reliability matter.",
...
export const hero = {
  ...
  headline:
    "Backend and security engineering grounded in production discipline.",
  summary:
    "Go and Python services, distributed telemetry, AI security review, binary analysis, and detection automation.",
  mission:
    "Measurable, defensible, dependable.",
  focus: [
    "Go and Python backend services with distributed data paths",
    "Tracing, observability, and root-cause analysis",
    "AI agent security review and tool-use constraint design",
    "Detection engineering, PKI/IAM automation, and secure delivery controls"
  ],
  actions: [
  ...
  utilityLinks: [
    ...
    { label: "Phone", href: "tel:+12408798063" }
  ]
};
...
export const experience = [
  {
    role: "Software Engineer (Security and Systems)",
    company: "DMV Music Alliance",
    period: "January 2025 - Present",
    location: "Washington, DC",
    summary:
      "Build and maintain distributed backend services in Go and Python while improving latency, observability coverage, and production recovery paths across the stack.",
    highlights: [
      "Removed latency bottlenecks across service boundaries in a microservices architecture, improving throughput and request responsiveness.",
      "Instrumented OpenTelemetry traces to isolate production deviations and drove self-healing workflows that reduced operational toil by 20%.",
      "Worked across application and network layers to improve observability signal while supporting shifting infrastructure priorities."
    ],
    tags: ["Go", "Python", "OpenTelemetry", "Distributed Systems", "Performance"]
  },
  {
    role: "Development and Testing Intern",
    company: "Code Gurukul",
    period: "June 2021 - December 2021",
    location: "Pune, India",
    summary:
      "Profiled Linux-based backend services, improved API latency, and supported release automation across distributed environments.",
    highlights: [
      "Optimized Linux backend services and improved API responsiveness for 4,300-plus users.",
      "Automated server configuration and release workflows with Bash-based tooling.",
      "Contributed to system design reviews and applied algorithmic improvements to backend APIs."
    ],
    tags: ["Linux", "Bash", "Backend APIs", "Performance", "Release Engineering"]
  }
];
...
export const evidenceDocuments = [
  {
    title: "ENPM665 Final Term Report",
    type: "Academic Report",
    year: "2025",
    summary:
      "Comprehensive final report covering cloud-security engineering choices, implementation notes, and outcomes.",
    href: "/documents/enpm665-final-term-report.pdf"
  },
  {
    title: "ENPM665 Vulnerability Scan Analysis",
    type: "Security Assessment",
    year: "2023",
    summary:
      "Detailed scan findings and interpretation document showing vulnerability context and remediation direction.",
    href: "/documents/enpm665-vulnerability-scan.pdf"
  },
  {
    title: "ENPM695 Week 8 Memory Management Notes",
    type: "Course Artifact",
    year: "2024",
    summary:
      "Applied notes on memory layout, allocator behavior, and secure memory-management concepts.",
    href: "/documents/enpm695-week8-memory-management.pdf"
  },
  {
    title: "ENPM695 Week 9 Processes and Threads Notes",
    type: "Course Artifact",
    year: "2024",
    summary:
      "Practical process/thread security notes including concurrency behavior and attack-surface implications.",
    href: "/documents/enpm695-week9-processes-threads.pdf"
  },
  {
    title: "ENPM695 Week 10 Secure Hardware Notes",
    type: "Course Artifact",
    year: "2024",
    summary:
      "Secure hardware references with design-level considerations for trust boundaries and system hardening.",
    href: "/documents/enpm695-week10-secure-hardware.pdf"
  },
  {
    ...
    year: "2021",
    summary:
      "Certification document from Cisco Networking Academy foundational program coursework.",
    href: "/documents/cisco-introduction-certificate.pdf"
  },
  {
    title: "FUEL Future Skill Coursera Certificate",
    type: "Certificate",
    year: "2021",
    summary:
      "Program certificate aligned with practical skill development and applied learning progression.",
    href: "/documents/fuel-future-skill-certificate.pdf"
  },
  {
    title: "FUEL LinkedIn Feedback Program Certificate",
    type: "Certificate",
    year: "2021",
    summary:
      "Program completion certificate demonstrating portfolio communication and professional branding work.",
    href: "/documents/fuel-linkedin-feedback-certificate.pdf"
  }
];
...
export const practiceFoundations = [
  "Grounded in UMD graduate coursework across information assurance, Linux administration, penetration testing, and cloud security.",
  "Strengthened through PEN-200 / PWK hands-on modules, applied exercises, challenge labs, and report-writing practice.",
  "Deepened with exploit-development reading on ASLR, format strings, stack overflows, integer security, and NULL-oriented exploitation."
];
