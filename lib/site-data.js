...
export const siteConfig = {
  ...
  description:
    "Portfolio of Atharva Gham, a software engineer focused on backend systems, platform reliability, observability, and security tooling.",
  availability:
...
export const hero = {
  eyebrow: "Backend Systems · Security Tooling · Observability",
  headline:
    "I build backend and security systems that stay understandable under pressure.",
  summary:
    "Most of my work lives where implementation meets operations: APIs, data flows, telemetry, debugging, and the security controls that keep systems usable in production.",
  mission:
    "Build systems that are useful, explainable, and reliable after launch.",
  focus: [
    "Backend services, ingestion pipelines, and APIs in Go, Python, and Rust",
    "Security tooling that fits into real developer and operator workflows",
    "Root-cause debugging across traces, packets, logs, and runtime behavior",
    "Documentation and rollout discipline that make systems easier to operate"
  ],
  actions: [
  ...
  utilityLinks: [
    ...
    { label: "LinkedIn", value: "Professional background and current profile", href: siteConfig.linkedin },
...
export const pathwayCards = [
  {
    ...
    href: "/about/",
    eyebrow: "Profile",
    body: "Background, working style, and the technical areas I keep investing in.",
...
export const stats = [
  {
    value: "50GB/day",
    label: "Telemetry processed across distributed ingestion pipelines"
  },
  {
    value: "1,000+",
