...
export const siteConfig = {
  ...
  description:
    "Portfolio of Atharva Gham, a software engineer focused on backend systems, platform workflows, observability, and security tooling.",
  availability:
...
export const hero = {
  ...
  headline:
    "Hey, I'm Atharva! 👋 I build robust systems, design smart security tools, and obsess over making things run smoothly.",
  summary:
    "I dive deep into backend architecture, track down bugs before they cause chaos, and ship secure code that humans actually enjoy using.",
  mission:
    "Dive deep, fix the root cause, and leave the code better than I found it.",
  focus: [
    "Building fast, reliable services in Go, Python, and Rust",
    "Tracing complex bugs across distributed systems to see what's really happening",
    "Making AppSec and AI-agent safety feel like a breeze, not a blocker",
    "Treating documentation and rollout safety as first-class engineering features"
  ],
  actions: [
    { label: "See what I've built", href: "/projects/", variant: "primary" },
    { label: "Let's grab a coffee (or chat)", href: "/contact/", variant: "secondary" }
  ],
  utilityLinks: [
    { label: "Current status", value: "Looking for my next big adventure in systems/security!", href: "/experience/" },
    { label: "LinkedIn", value: "Where I keep my professional timeline", href: siteConfig.linkedin },
    { label: "Get in touch", value: "Send a direct message straight to my inbox", href: "/contact/" }
  ]
};
...
export const contactConfig = {
  ...
  deliveryNote: "Form submissions are delivered privately to my inbox.",
...
export const pathwayCards = [
  ...
  },
  {
    ...
    body: "Interactive case studies across distributed systems, security products, AI security, binary analysis, and application security.",
  ...
  },
  {
    ...
    body: "Hands-on systems, security, and reverse-engineering work distilled into patterns, workflows, and applied takeaways.",
...
export const stats = [
  {
    value: "50GB/day",
    label: "Data flowing smoothly through distributed pipelines"
  },
  {
    value: "1,000+",
    label: "Alerts cleanly handled daily by AI-driven automation"
  },
  {
    value: "13+",
    label: "Core systems monitored and kept healthy"
  },
  {
    value: "20%",
    label: "Reduction in tedious manual work through smart automation"
  }
];
...
export const selectedWins = [
  {
    value: "40%",
    label: "Faster time-to-fix after shining a light on production traces"
  },
  {
    value: "1,000+ / week",
    label: "Alerts automatically enriched, keeping humans focused on real work"
  },
  {
    value: "30%",
    label: "Faster rollouts because nobody should be manually deploying servers"
  }
];

export const buildThemes = [
  {
    title: "Backend Services and Internal APIs",
    body:
      "Concurrent services, ingestion paths, reliability controls, and the operational details that keep core systems predictable under load."
  },
  {
    title: "Observability and Incident Tooling",
    body:
      "Tracing, metrics, dashboards, and debugging workflows that shorten the distance from symptom to mechanism."
  },
  {
    title: "Security Automation and Guardrails",
    body:
      "CI checks, policy gates, detection content, IAM workflows, and application-security automation teams can keep running."
  },
  {
    title: "Research-Driven Systems Work",
    body:
      "Low-level debugging, exploit analysis, and architectural writeups that improve both engineering judgment and defensive design."
  }
];
...
export const projects = [
  ...
  },
  {
    ...
    metrics: [
      { value: "50GB/day", label: "Telemetry volume sustained" },
      { value: "End-to-end", label: "Ownership from design through rollout" },
      { value: "High availability", label: "Failure-tolerant ingestion path" }
    ],
    architecture: [
