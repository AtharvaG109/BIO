...
export const hero = {
  ...
  headline:
    "I build backend systems, platform workflows, and security products that hold up under production pressure.",
  summary:
    "Most valuable on teams that need one engineer to move between service design, observability, debugging, rollout safety, and security controls that actually ship.",
  mission:
    "Own the hard parts. Measure the outcome. Ship the fix.",
  focus: [
    "Go, Python, and Rust systems work across backend services and security tooling",
    "Observability, tracing, and production root-cause analysis",
    "Security automation, AppSec guardrails, and AI-agent safety review",
    "Platform-minded delivery with rollout safety, docs, and operational follow-through"
  ],
  actions: [
  ...
  utilityLinks: [
    { label: "Best fit", value: "Backend, platform, systems, and security roles", href: "/experience/" },
    { label: "LinkedIn", value: "Professional profile and career timeline", href: siteConfig.linkedin },
    { label: "Private contact", value: "Structured outreach delivered privately to my inbox", href: "/contact/" }
  ]
};
...
export const selectedWins = [
  {
    value: "40%",
    label: "Faster identification of production bottlenecks after end-to-end trace coverage improvements"
  },
  {
    value: "1,000+ / week",
    label: "Security alerts enriched through automation instead of repetitive manual triage"
  },
  {
    value: "30%",
    label: "Faster rollout and validation loops after automation of deployment and verification routines"
  }
];
