...
export const siteConfig = {
  ...
  description:
    "Portfolio of Atharva Gham, a software engineer focused on backend systems, platform reliability, observability, and security automation.",
  availability:
...
export const hero = {
  ...
  headline:
    "I build backend systems, platform workflows, and security tooling that hold up under production pressure.",
  summary:
    "Most valuable on teams that need someone to own the hard middle: service design, observability, debugging, rollout safety, and security controls that actually ship.",
  mission:
    "Clear ownership. Measurable impact. Reliable delivery.",
  focus: [
