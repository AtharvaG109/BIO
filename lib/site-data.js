...
export const hero = {
  ...
  utilityLinks: [
    ...
    { label: "Recent work", value: "tinyc, Enterprise NIDS, Patchbot, Sysguard, and systems security projects", href: "/projects/" },
...
export const projects = [
  {
    ...
    summary:
      "Built a from-scratch C compiler with a practical C99 frontend, x86-64 code generation, aggregate ABI coverage, integration tests, and a deterministic self-hosting milestone.",
    impact:
    ...
    approach: [
      ...
      "Built a self-host workflow with bundled headers, deterministic macOS linking, and stage1-to-stage2 comparison for a reproducible compiler milestone."
    ],
    result:
      "tinyc now ships as a GitHub-ready compiler project with documentation, CI, public tests, a working self-host target, and a documented set of remaining C99 and ABI boundaries.",
    outcomes: [
    ...
    tradeoffs: [
      "Kept the milestone bounded to a practical C99 slice instead of claiming full C99 or full platform ABI completeness.",
      ...
      "Documented remaining ABI and language boundaries so the project is honest about what is validated versus what is future work."
    ],
