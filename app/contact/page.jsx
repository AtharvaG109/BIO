  ...
  return (
    <main id="main-content" tabIndex="-1" className="page-shell page-main">
      <PageHero
        ...
        copy="I keep direct phone details off the public site. Use the request form for serious roles, project discussions, research conversations, or collaboration."
        actions={[
